...
class inf(Toplevel):
    def __init__(self, root):
        ...
        self.image_about = PhotoImage(file="./fff.png")
        ...
        self.lbl_text = Label(self.lbl_about, text='ФИО: Хачатурян Арсений Робертович', justify = LEFT)
        ...
        self.lbl_text_3 = Label(self.lbl_about, text='e-mail: arseniy37@mail.ru',  justify = LEFT)
